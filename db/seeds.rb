...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  Carousel.create!(store_id: 1, picture: 'http://shop-picture.qiniudn.com/s8.jpg')
  Carousel.create!(store_id: 1, picture: 'http://shop-picture.qiniudn.com/s7.jpg')
  Carousel.create!(store_id: 1, picture: 'http://shop-picture.qiniudn.com/s6.jpg')
  Carousel.create!(store_id: 1, picture: 'http://shop-picture.qiniudn.com/s5.jpg')
  11.times do |n|
    name = "车-#{n+1}"
